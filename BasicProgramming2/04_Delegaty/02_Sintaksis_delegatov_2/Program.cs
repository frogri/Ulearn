/*
Можно было не создавать свой делегат TellUser в прошлой задаче, а использовать Action. 
Но в некоторых ситуациях Action и Func недостаточно.
...
namespace Sintaksis_delegatov_2
{
    internal class Program
    {
        public delegate bool TryGet<T1, T2>(T1 argument, Action<string> action, out T2 result);
